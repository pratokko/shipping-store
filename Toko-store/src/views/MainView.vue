  ...
  <div class="flex flex-no-wrap bg-gray-200">
      ...
      <div class="w-64 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between hidden sm:flex">
          <div>
              ...
              <ul class="mt-12">
                  <li class="flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center py-3 px-8">
                  ...
                  <li class="flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3">
                      <div class="flex items-center">
              ...
              <div class="flex items-center mt-48 mb-4 px-8">
                  ...
                  <div>
                      <p class="text-gray-600 text-sm font-medium">Steve Doe</p>
      ...
      <div class="w-64 z-40 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav">
          <div id="openSideBar" class="h-10 w-10 bg-indigo-900 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer" @click="sidebarHandler(true)">
          ...
          <div id="closeSideBar" class="hidden h-10 w-10 bg-indigo-900 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white" @click="sidebarHandler(false)">
...
<script>
export default {
  name: "LightWithIconsAtBottomAlternateStyle",
  data() {
      return {
          moved: true,
      };
