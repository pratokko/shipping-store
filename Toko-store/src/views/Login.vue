        ...
        >
          ...
          <div class="mt-8">
            <div class="flex items-center justify-between">
              <label class="text-sm font-medium text-gray-600 mr-4">
                <input type="checkbox" class="mr-4" />
                Remember me
              </label>
              <router-link
               :to="{name: 'Reset'}" class="text-sm font-medium text-indigo-700 underline"
            ...
            <button
              ...
              class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full mt-4"
            >
              Login
        </button>
          </div>
