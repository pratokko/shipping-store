    ...
    <div class="dark:bg-gray-900">
      <div class="container mx-auto relative">
        <div class="py-4 mx-4 md:mx-6">
          <div
            class="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 py-4"
          >
            <div>
              <div
              ...
              >
                <svg
                  class="fill-stroke dark:text-white text-gray-900"
                  width="55"
                  height="25"
                  viewBox="0 0 55 25"
                  fill="none"
              ...
              <div
                class="hidden md:block lg:hidden cursor-pointer"
                role="img"
                aria-label="luxe. Logo."
              >
                <svg
                  class="fill-stroke dark:text-white text-gray-800"
                  width="44"
                  height="20"
                  viewBox="0 0 44 20"
                  fill="none"
                  ...
                  <a
                    ...
                    @mouseleave="
                      hideDropdown
                        ...
                        : (hideDropdown = true)
                    "
                    class="text-base text-right text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"
                    >How it works</a
                  >
                  <div
                    v-if="showDropdown"
                    class="absolute z-50 mt-2 py-2 bg-white rounded-md shadow-md"
                    @mouseenter="hideDropdown = false"
                    @mouseleave="showDropdown = false"
                  >
                    <ul class="list-none">
                      <li
                        class="p-2 border-b border-gray-200 hover:bg-gray-100"
                      >
                        <a
                          href="#"
                          class="block text-base text-gray-800 hover:underline"
                          >Option thid is a big option1</a
                        >
                      </li>
                      <li
                        class="p-2 border-b border-gray-200 hover:bg-gray-100"
            ...
            <div class="hidden md:flex items-center space-x-4">
              <button
                ...
                class="text-gray-800 dark:hover:text-gray-300 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800"
              >
                <svg
                  class="fill-stroke"
                  width="24"
              ...
              <a
                ...
                href="javascript:void(0)"
                @mouseenter="createAccount = true"
                @mouseleave="
                  hideDropdown ? (createAccount = false) : (hideDropdown = true)
                "
                class="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded"
              >
                <svg
                ...
                <div
                  ...
                  class="absolute z-50 mt-2 py-2 bg-white rounded-md shadow-md"
                  @mouseenter="hideDropdown = false"
                  @mouseleave="createAccount = false"
                >
                  <ul class="list-none">
                    <li class="p-2 border-b border-gray-200 hover:bg-gray-100">
                      <router-link
                        :to="{name: 'Login'}"
                        class="block text-base text-gray-800 hover:underline"
                        >Sign-In</router-link
              ...
              <!-- <a aria-label="Favourites" href="javascript:void(0)" class="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded">
                                <svg class="fill-stroke text-gray-800 dark:text-white" width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <div class="md:hidden">
              <button
                ...
                @click="menu = true"
                class="focus:outline-none focus:ring-2 focus:ring-gray-800 rounded"
              >
                <svg
                  class="fill-stroke text-gray-800 dark:text-white"
                  width="24"
          ...
          <div
            class="mt-4 pb-4 flex space-x-3 border-b border-gray-200 dark:border-gray-700"
          >
            <div>
              <svg
                class="fill-stroke text-gray-600 dark:text-white"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <input
              ...
              class="focus:outline-none bg-transparent text-sm text-gray-600"
            />
          </div>
        </div>
        ...
        <div
          id="mobile-menu"
          v-if="menu"
          class="dark:bg-gray-900 md:hidden absolute inset-0 z-10 flex flex-col w-full h-screen bg-white pt-6"
        >
          <div class="w-full">
            <div
              class="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-3 mx-4"
            >
          ...
          <div class="mt-4 mx-4">
            <ul class="flex flex-col space-y-4">
              <li
                class="border-b border-gray-200 dark:border-gray-700 dark:text-gray-700 pb-4 px-1 flex items-center justify-between"
              >
                <a
                  href="javascript:void(0)"
                  class="dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline"
                >
                  New
                </a>
                <button
                  aria-label="Add"
                  class="dark:text-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100 dark:hover:bg-gray-700"
                >
                  <svg
                    class="fill-stroke"
                    width="16"
          ...
          <div class="w-full h-full flex items-end">
            <ul
              class="bg-gray-50 dark:bg-gray-800 py-10 px-4 flex flex-col space-y-8 w-full"
            >
              <li>
                <a
                  class="flex items-center space-x-2 focus:outline-none text-gray-800 dark:text-white focus:ring-2 focus:ring-gray-800 hover:underline"
                  href="javascript:void(0)"
                >
                  <div>
                    <svg
              ...
              <!-- <li>
                <a
                  class="flex items-center space-x-2 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"
                  href="javascript:void(0)"
                >
                  <div>
                    <svg
