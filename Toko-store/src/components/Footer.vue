  ...
  <div class="overflow-hidden">
    <div class="mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4">
      ...
      >
        ...
        <div class="sm:ml-0 ml-8 flex flex-col">
          ...
          <a
            ...
            class="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 cursor-pointer"
            >Blog</a
          >
          <a
            href="javascript:void(0)"
        ...
        <div class="mt-10 lg:block hidden">
          <label class="text-xl font-medium leading-5 text-gray-800"
            >Get updates</label
          >
          <div
            class="cursor-pointer flex items-center justify-between border border-gray-800 mt-4"
          >
            <input
              type="text"
      ...
      <div class="mt-10 lg:hidden">
        ...
        >
        <div
          class="flex items-center justify-between border border-gray-800 mt-4"
        >
          <input
            type="text"
